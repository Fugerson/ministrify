...
<div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
    <div class="px-4 lg:px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        ...
        <a href="{{ route('announcements.index') }}" class="text-sm text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-1 px-2 py-2 -mr-2 min-h-[44px]">
    ...
    <div class="divide-y divide-gray-50 dark:divide-gray-700">
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">{{ __('app.no_announcements') }}</p>
        </div>
        @endforelse
    </div>
</div>
