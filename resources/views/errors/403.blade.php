...
<body class="font-sans antialiased bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 min-h-screen">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-8">
        <div class="max-w-md w-full text-center">
            {{-- Icon --}}
            <div class="mx-auto w-24 h-24 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-red-200/50 dark:shadow-red-900/30">
            ...
            {{-- Error code --}}
            <p class="text-7xl font-bold text-red-500/20 dark:text-red-400/20 mb-2">403</p>
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                {{ $exception->getMessage() ?: 'У вас немає дозволу для перегляду цієї сторінки. Зверніться до адміністратора, якщо вважаєте, що це помилка.' }}
            </p>
