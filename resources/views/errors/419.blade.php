...
<head>
    ...
    <title>419 - Сесія закінчилась | Ministrify</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 min-h-screen">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-8">
        <div class="max-w-md w-full text-center">
            {{-- Icon --}}
            <div class="mx-auto w-24 h-24 bg-violet-100 dark:bg-violet-900/30 rounded-full flex items-center justify-center mb-6 shadow-lg shadow-violet-200/50 dark:shadow-violet-900/30">
            ...
            {{-- Error code --}}
            <p class="text-7xl font-bold text-violet-500/20 dark:text-violet-400/20 mb-2">419</p>
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
                Ваша сесія закінчилась через тривалу неактивність. Будь ласка, оновіть сторінку та спробуйте ще раз.
            </p>
