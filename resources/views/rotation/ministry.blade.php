...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <button onclick="autoAssignAll()"
                class="px-3 sm:px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl transition-colors inline-flex items-center gap-2 whitespace-nowrap">
...
async function autoAssignAll() {
    if (!await confirmDialog(@js( __('messages.confirm_auto_assign') ))) return;
