...
@section('title', __('app.edit_ministry_title'))
...
<div class="max-w-2xl mx-auto">
    ...
    <form @submit.prevent="submit($refs.ministryEditForm)" x-ref="ministryEditForm" class="space-y-6"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('app.edit_ministry_title') }}</h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('app.description') }}</label>
                ...
                <div>
                    ...
                    <x-person-select name="leader_id" :people="$people" :selected="old('leader_id', $ministry->leader_id)" :placeholder="__('app.search_leader')" />
                </div>

                <div>
                    <label for="color" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('app.color') }}</label>
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <label for="is_worship_ministry" class="text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <span class="block text-gray-500 dark:text-gray-400 text-xs">{{ __('app.show_songs_music_stand') }}</span>
                    </label>
                </div>
