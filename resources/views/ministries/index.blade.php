...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    @forelse($ministries as $ministry)
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-6">
                <div class="flex items-start justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            @if($ministry->leader)
                                <p class="text-sm text-gray-500">Лідер: {{ $ministry->leader->full_name }}</p>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <p class="text-sm text-gray-600">Учасників: {{ $ministry->members->count() }}</p>
                </div>
                ...
                @if($ministry->monthly_budget)
                    <div class="mt-4">
                        <div class="flex items-center justify-between text-sm mb-1">
                            ...
                            <span class="text-gray-900">{{ number_format($ministry->spent_this_month, 0, ',', ' ') }} / {{ number_format($ministry->monthly_budget, 0, ',', ' ') }} &#8372;</span>
                        </div>
    ...
    @empty
        <div class="col-span-full text-center py-12">
            ...
            @admin
            <a href="{{ route('ministries.create') }}" class="mt-2 inline-block text-primary-600 hover:text-primary-500">
