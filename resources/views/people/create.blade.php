            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="file" name="photo" id="photo" accept="image/*"
                           class="w-full px-3 py-2.5 md:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm">
                </div>
            </div>
        </div>
