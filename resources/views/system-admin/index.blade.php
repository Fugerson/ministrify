...
<div class="space-y-6">
        ...
        <div class="bg-gray-800 rounded-2xl p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1">{{ $stats['churches'] }}</p>
                </div>
        ...
        <div class="bg-gray-800 rounded-2xl p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1">{{ $stats['people'] }}</p>
                </div>
        ...
        <div class="bg-gray-800 rounded-2xl p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-1">{{ $stats['events'] }}</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
                ...
                <a href="{{ route('system.churches.index') }}" class="text-red-400 hover:text-red-300 text-sm">Всі →</a>
            </div>
            <div class="divide-y divide-gray-700">
                @forelse($recentChurches as $church)
                <a href="{{ route('system.churches.show', $church) }}" class="flex items-center px-6 py-4 hover:bg-gray-700/50">
                    <div class="w-10 h-10 rounded-lg bg-blue-600/20 flex items-center justify-center mr-4">
                        <span class="text-lg">⛪</span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-white truncate">{{ $church->name }}</p>
                        <p class="text-sm text-gray-400">{{ $church->city }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-sm text-gray-300">{{ $church->users_count }} користувачів</p>
                        <p class="text-xs text-gray-500">{{ $church->people_count }} людей</p>
                    </div>
                </a>
                @empty
        ...
        <div class="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
                ...
                <a href="{{ route('system.users.index') }}" class="text-red-400 hover:text-red-300 text-sm">Всі →</a>
            </div>
            <div class="divide-y divide-gray-700">
                ...
                <div class="flex items-center px-6 py-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @endif
                        <span class="px-2 py-0.5 bg-gray-700 text-gray-300 text-xs rounded-full">{{ $user->role }}</span>
                    </div>
                </div>
                @empty
    ...
    <div class="bg-gray-800 rounded-2xl border border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-700 flex items-center justify-between">
            ...
            <a href="{{ route('system.audit-logs') }}" class="text-red-400 hover:text-red-300 text-sm">Всі →</a>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-700/30">
                        ...
                        <td class="px-6 py-3 text-sm text-gray-400">{{ $log->church?->name ?? '-' }}</td>
                        <td class="px-6 py-3">
