...
@section('title', __('Редагувати витрату'))
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('Редагувати витрату') }}</h2>
            <x-delete-confirm
                :action="route('finances.expenses.destroy', $expense)"
                :title="__('Видалити витрату?')"
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <label class="mt-3 flex items-center">
                                ...
                                <span class="ml-2 text-sm text-orange-800 dark:text-orange-200">{{ __('Все одно зберегти (потрібне підтвердження)') }}</span>
                            </label>
                        </div>
                    </div>
                </div>
