...
<div class="flex items-center gap-1">
    <a href="{{ route('my-schedule') }}" class="p-2 text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors" title="Мій розклад">
