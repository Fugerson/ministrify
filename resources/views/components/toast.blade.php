...
<div x-data="toastNotifications()"
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="toast.visible"
            ...
            <!-- Close button -->
            <button @click="remove(toast.id)" class="flex-shrink-0 p-1 text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
