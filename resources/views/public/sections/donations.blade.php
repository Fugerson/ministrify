...
<section class="py-16 bg-gradient-to-br from-primary-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900">{{ __('app.support_us') }}</h2>
            <p class="text-gray-600 mt-2">{{ __('app.your_donation_helps') }}</p>
        </div>
                    ...
                    @if($campaign->goal_amount)
                        <div class="mt-4">
                            <div class="flex justify-between text-sm mb-2">
                                <span class="text-gray-500">{{ __('app.raised') }}</span>
...
<section class="py-16 bg-gradient-to-br from-primary-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-900 text-lg">{{ __('app.general_fund') }}</h3>
                <p class="text-sm text-gray-500 mt-2">{{ __('app.general_fund_desc') }}</p>
                <div class="mt-4">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-500">{{ __('app.raised') }}</span>
                        <span class="font-medium text-gray-900">15 000 / 50 000 грн</span>
                    </div>
                    <div class="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-900 text-lg">{{ __('app.mission_project') }}</h3>
                <p class="text-sm text-gray-500 mt-2">{{ __('app.mission_project_desc') }}</p>
                <div class="mt-4">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-500">{{ __('app.raised') }}</span>
                        <span class="font-medium text-gray-900">8 000 / 20 000 грн</span>
                    </div>
                    <div class="w-full h-3 bg-gray-100 rounded-full overflow-hidden">
