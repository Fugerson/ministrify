...
<section class="py-16 bg-gradient-to-br from-primary-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-900 text-lg">Загальний фонд церкви</h3>
                <p class="text-sm text-gray-500 mt-2">Підтримка щоденної діяльності церкви, оплата комунальних послуг та утримання приміщення</p>
                <div class="mt-4">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-500">Зібрано</span>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 class="font-semibold text-gray-900 text-lg">Місіонерський проект</h3>
                <p class="text-sm text-gray-500 mt-2">Підтримка місіонерських поїздок та євангелізаційних програм</p>
                <div class="mt-4">
                    <div class="flex justify-between text-sm mb-2">
                        <span class="text-gray-500">Зібрано</span>
