...
@section('title', __('app.contact_us') . ' - ' . $church->name)

@section('content')
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <!-- Header -->
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">{{ __('app.public_contact_title') }}</h1>
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">
            {{ __('app.public_contact_subtitle') }}
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
                <h2 class="text-xl font-bold text-gray-900 mb-6">{{ __('app.contact_info') }}</h2>
                ...
                <div class="space-y-6">
                    @if($church->address)
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">{{ __('app.address') }}</h3>
                    ...
                    @if($church->public_phone)
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">{{ __('app.phone') }}</h3>
                    ...
                    @if($church->service_times)
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">{{ __('app.worship_services') }}</h3>
            ...
            @if($church->facebook_url || $church->instagram_url || $church->youtube_url || $church->website_url)
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    <h2 class="text-xl font-bold text-gray-900 mb-6">{{ __('app.follow_us') }}</h2>
                ...
                @else
                    <div class="w-full h-full bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center">
                        <div class="text-center text-white p-8">
                            ...
                            <p class="text-white/80">{{ __('app.welcome_message') }}</p>
                        </div>
                    </div>
                @endif
            </div>
