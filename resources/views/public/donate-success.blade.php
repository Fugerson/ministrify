...
@section('title', __('app.donate_thanks') . ' - ' . $church->name)
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="text-center">
        ...
        <h1 class="text-4xl font-bold text-gray-900 mb-4">{{ __('app.thank_you_generosity') }}</h1>
        ...
        <p class="text-xl text-gray-600 mb-8 max-w-lg mx-auto">
            {{ __('app.donation_bless_message') }}
        </p>

        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
            <h3 class="font-semibold text-gray-900 mb-4">{{ __('app.what_next') }}</h3>
            <ul class="space-y-3 text-left text-gray-600">
                <li class="flex items-start gap-3">
                    ...
                    <span>{{ __('app.email_confirmation_note') }}</span>
                </li>
                <li class="flex items-start gap-3">
                    <svg class="w-5 h-5 text-primary-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span>{{ __('app.donation_purpose_note') }}</span>
                </li>
                <li class="flex items-start gap-3">
                    <svg class="w-5 h-5 text-primary-500 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <span>{{ __('app.join_events_teams') }}</span>
                </li>
            </ul>
        </div>
