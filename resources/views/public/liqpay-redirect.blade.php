...
<head>
    ...
    <title>{{ __('app.redirecting_to_liqpay') }} - {{ $church->name }}</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="text-center">
        ...
        <h1 class="text-xl font-semibold text-gray-900 mb-2">{{ __('app.redirecting_to_liqpay') }}</h1>
        <p class="text-gray-500">{{ __('app.please_wait') }}</p>
    </div>
