            ...
            <div class="h-full bg-white dark:bg-gray-900 shadow-xl flex flex-col">
                ...
                <template x-if="!cardPanel.loading && !cardPanel.error && cardPanel.data">
                    <div class="flex-1 flex flex-col overflow-hidden">
                                ...
                                <div class="flex-1 pr-4">
                                    ...
                                    <div class="flex items-center gap-2 mb-2 flex-wrap">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium"
                                              :class="{
                                                  'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300': cardPanel.data.column_name === @js(__('app.board_col_new')),
                                                  'bg-blue-100 text-blue-700 dark:bg-blue-900/50 dark:text-blue-300': cardPanel.data.column_name === @js(__('app.board_col_todo')),
                                                  'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/50 dark:text-yellow-300': cardPanel.data.column_name === @js(__('app.board_col_in_progress')),
                                                  'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300': cardPanel.data.column_name === @js(__('app.board_col_done'))
                                              }"
                        ...
                        <!-- Hidden file input for header attach button -->
                        <input type="file" multiple x-ref="cardFileInput" class="hidden" @change="uploadAttachments($event)">
