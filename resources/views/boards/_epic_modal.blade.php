...
<div x-show="showEpicModal" x-cloak
     ...
     @keydown.escape.window="showEpicModal = false">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="fixed inset-0 bg-black/60 backdrop-blur-sm" @click="showEpicModal = false"></div>
        <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md z-10 p-6"
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button @click="showEpicModal = false" class="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <form @submit.prevent="createEpic()">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea x-model="newEpic.description" rows="2"
                                  placeholder="Короткий опис цілей епіку..."
                ...
                <div class="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button type="button" @click="showEpicModal = false"
                            class="px-4 py-2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 font-medium">
                        Скасувати
                    </button>
                    <button type="submit" :disabled="!newEpic.name.trim()"
