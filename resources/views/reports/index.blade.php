...
@section('title', __('app.reports_title'))

@section('content')
<div class="space-y-6">
    <!-- Header -->
    <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ __('app.reports_title') }}</h1>
        <p class="text-gray-600 dark:text-gray-400">{{ __('app.reports_subtitle') }}</p>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.reports_total_people') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.reports_active_3months') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.reports_events_this_year') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 text-center">
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.reports_volunteers') }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <a href="{{ route('reports.attendance') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ __('app.reports_attendance') }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('app.reports_attendance_desc') }}</p>
            <span class="text-primary-600 dark:text-primary-400 text-sm font-medium group-hover:underline">{{ __('app.reports_view') }}</span>
        </a>
        @endif
        ...
        <a href="{{ route('reports.finances') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ __('app.reports_finances') }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('app.reports_finances_desc') }}</p>
            <span class="text-primary-600 dark:text-primary-400 text-sm font-medium group-hover:underline">{{ __('app.reports_view') }}</span>
        </a>
        ...
        <a href="{{ route('reports.volunteers') }}" class="group bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">{{ __('app.reports_volunteers_title') }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ __('app.reports_volunteers_desc') }}</p>
            <span class="text-primary-600 dark:text-primary-400 text-sm font-medium group-hover:underline">{{ __('app.reports_view') }}</span>
        </a>
    </div>
</div>
