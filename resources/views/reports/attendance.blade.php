...
<div x-data="{
    ...
    async applyFilters() {
        ...
        if (this.ministryId) params.set('ministry_id', this.ministryId);
        ...
        try {
            ...
            if (newContent) {
                ...
                // Re-init charts: extract and execute scripts from new content
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div class="flex items-center space-x-2">
            ...
            <select x-model="ministryId" @change="applyFilters()"
                    class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-sm text-gray-900 dark:text-white">
        ...
        onPageReady(function() {
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        legend: { position: 'top', labels: { font: { size: window.innerWidth < 640 ? 13 : 15 }, boxWidth: window.innerWidth < 640 ? 12 : 40, padding: 16 } }
                    },
                    scales: {
                        y: { beginAtZero: true }
                    }
