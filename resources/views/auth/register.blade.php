...
@section('title', __('auth.registration_title'))
...
<a href="{{ route('auth.google') }}"
   class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-200 mb-6">
    ...
    <span class="font-medium text-gray-700 dark:text-gray-200">{{ __('auth.quick_google_registration') }}</span>
</a>
...
<div class="relative mb-6">
    ...
    <div class="relative flex justify-center text-sm">
        <span class="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">{{ __('auth.or_fill_form') }}</span>
    </div>
</div>
@endif
...
<form method="POST" action="{{ route('register') }}" x-data="{ showPassword: false }">
    ...
    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">{{ __('auth.register_church') }}</h2>

    <div class="mb-4">
        <label for="church_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('auth.church_name') }}</label>
    ...
    <div class="mb-4">
        <label for="city" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('auth.city') }}</label>
    ...
    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">{{ __('auth.administrator') }}</h3>

    <div class="mb-4">
        <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('auth.your_name') }}</label>
    ...
    <div class="mb-4">
        <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('auth.phone_optional') }}</label>
    ...
    <div class="mb-4">
        <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('auth.password_label') }}</label>
        <div class="relative">
