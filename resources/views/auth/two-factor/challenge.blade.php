...
<head>
    ...
    <title>Двофакторна аутентифікація - Ministrify</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Двофакторна аутентифікація</h1>
            <p class="text-gray-500 mt-2">Введіть код з вашого додатку аутентифікації</p>
        </div>
            ...
            <form action="{{ route('two-factor.verify') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-xs text-gray-400 mt-2 text-center">
                        Або введіть код відновлення (xxxx-xxxx)
                    </p>
                </div>
