...
<head>
    ...
    <title>{{ __('app.two_factor_auth') }} - Ministrify</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-900">{{ __('app.two_factor_auth') }}</h1>
            <p class="text-gray-500 mt-2">{{ __('app.enter_auth_app_code') }}</p>
        </div>
