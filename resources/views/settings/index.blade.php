    ...
    <div id="settings-tabs" class="relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-1.5 sm:p-2">
        ...
        <div class="flex gap-1 sm:gap-2 min-w-max">
            <button @click="setTab('general')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'general' }"
            ...
            <button @click="setTab('public')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'public' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_public') }}
            </button>
            <button @click="setTab('integrations')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'integrations' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_integrations') }}
            </button>
            <button @click="setTab('data')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'data' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_data') }}
            </button>
            <button @click="setTab('finance')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'finance' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.finances') }}
            </button>
            <button @click="setTab('users')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'users' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_users') }}
            </button>
<button @click="setTab('permissions')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'permissions' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_permissions') }}
            </button>
            <button @click="setTab('audit')"
                    :class="{ 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white': activeTab === 'audit' }"
                    class="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors whitespace-nowrap flex-shrink-0">
                {{ __('app.tab_audit') }}
            </button>
        </div>
    ...
    <!-- Delete All Events -->
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700"
         x-data="deleteAllEventsComponent()">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center gap-3">
        ...
        <div class="p-6">
            <button @click="if (!await confirmDialog({{ Js::from(__('messages.confirm_delete_all_events')) }})) return; doDelete()"
                    :disabled="loading"
            ...
            <div x-show="message" x-transition class="mt-3 text-sm"
    ...
    <script>
    function deleteAllEventsComponent() {
        return {
            loading: false,
            message: '',
            success: false,
            async doDelete() {
                ...
                try {
                    ...
                    this.message = data.message || @js(__('app.settings_done'));
                    ...
                    @foreach($transactionCategories->where('type', 'income') as $category)
                        <div x-data="{ editing: false }" class="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                            ...
                            <form x-show="editing" @submit.prevent="submit($refs.editCatForm{{ $category->id }})" x-ref="editCatForm{{ $category->id }}" class="flex-1 flex items-center gap-2"
                                  x-data="{ ...ajaxForm({ url: '{{ route('settings.transaction-categories.update', $category) }}', method: 'PUT', stayOnPage: true, onSuccess() { const container = this.$el.closest('.p-3'); const display = container.children[0]; if (display) { const nameSpan = display.querySelector('span:last-child'); const colorDot = display.querySelector('.rounded-full'); const form = this.$el.closest('form'); if (nameSpan) nameSpan.textContent = form.querySelector('[name=name]').value; if (colorDot) colorDot.style.backgroundColor = form.querySelector('[name=color]').value; } editing = false; } }) }">
