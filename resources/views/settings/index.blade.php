       ...
       class="block bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500 transition-colors">
        <div class="p-6 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Ролі та права доступу</h2>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Церковні ролі та їх права доступу до системи</p>
                </div>
            </div>
