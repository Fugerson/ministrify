...
<div class="max-w-6xl mx-auto space-y-4 md:space-y-6" x-data="{
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700"
         x-data="{
             notifyOnAssignment: {{ ($church->settings['notifications']['notify_on_assignment'] ?? true) ? 'true' : 'false' }},
             notifyOnResponsibility: {{ ($church->settings['notifications']['notify_on_responsibility'] ?? true) ? 'true' : 'false' }},
             notifyOnPlanRequest: {{ ($church->settings['notifications']['notify_on_plan_request'] ?? true) ? 'true' : 'false' }},
             notifyLeaderOnDecline: {{ ($church->settings['notifications']['notify_leader_on_decline'] ?? true) ? 'true' : 'false' }},
             birthdayReminders: {{ ($church->settings['notifications']['birthday_reminders'] ?? true) ? 'true' : 'false' }},
             reminderDayBefore: {{ ($church->settings['notifications']['reminder_day_before'] ?? true) ? 'true' : 'false' }},
             reminderSameDay: {{ ($church->settings['notifications']['reminder_same_day'] ?? true) ? 'true' : 'false' }},
             ...
             save() {
                 ...
                 fetch('{{ route('settings.notifications') }}', {
                     ...
                     body: JSON.stringify({
                         notify_on_assignment: this.notifyOnAssignment,
                         notify_on_responsibility: this.notifyOnResponsibility,
                         notify_on_plan_request: this.notifyOnPlanRequest,
                         notify_leader_on_decline: this.notifyLeaderOnDecline,
                         birthday_reminders: this.birthdayReminders,
                         reminder_day_before: this.reminderDayBefore,
                         reminder_same_day: this.reminderSameDay,
        ...
        <div class="p-6 space-y-6">
            <!-- Section: Автоматичні сповіщення -->
            <div>
                <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Автоматичні сповіщення</h3>
                <div class="space-y-5">
                    ...
                    <label class="flex items-center justify-between cursor-pointer">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="notifyOnAssignment" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-center justify-between cursor-pointer">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="notifyOnResponsibility" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-center justify-between cursor-pointer">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="notifyOnPlanRequest" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>

                    <!-- Leader decline notifications -->
                    <label class="flex items-center justify-between cursor-pointer">
                        <div class="flex items-center gap-3">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="notifyLeaderOnDecline" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>
            ...
            <!-- Section: Нагадування -->
            <div>
                <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">Нагадування</h3>
                <div class="space-y-5">
                    <!-- Day before reminder -->
                    <label class="flex items-center justify-between cursor-pointer">
                        <div class="flex items-center gap-3">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="reminderDayBefore" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>
                    ...
                    <label class="flex items-center justify-between cursor-pointer">
                        ...
                        <div class="relative inline-flex">
                            <input type="checkbox" x-model="reminderSameDay" @change="save()" class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
                        </div>
                    </label>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            Ручні повідомлення (розсилки, чат) завжди доступні незалежно від цих налаштувань.
                        </p>
                    </div>
                </div>
            </div>
