...
<head>
    ...
    <title>Ministrify - {{ __('app.setup') }}</title>
        ...
        <div class="w-full max-w-5xl card overflow-hidden flex flex-col lg:flex-row">
            ...
            <aside class="w-full lg:w-80 p-6 lg:p-8 flex-shrink-0 relative bg-gray-50/80 dark:bg-slate-800/80">
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium theme-primary">{{ __('app.setup') }}</p>
                    </div>
                </div>

                <!-- Steps Navigation -->
                <nav class="space-y-1 mb-8">
                    <p class="text-[10px] font-bold uppercase tracking-wider mb-3 px-4 text-gray-400 dark:text-gray-500">{{ __('app.setup_steps') }}</p>
                        ...
                        >
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                @if(!$stepConfig['required'])
                                    <p class="text-xs text-gray-400 dark:text-gray-500">{{ __('app.optional') }}</p>
                                @endif
                            </div>
                ...
                <div class="rounded-2xl p-5 shadow-sm border bg-white dark:bg-slate-700/50 border-gray-100 dark:border-slate-600/50">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <p class="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500">{{ __('app.progress_label') }}</p>
                    ...
                    <p class="mt-3 text-xs text-gray-500 dark:text-gray-400">
                        <span class="font-semibold theme-primary" x-text="progress.completed"></span> {{ __('app.of_word') }} <span x-text="progress.total"></span> {{ __('app.steps_completed') }}
                    </p>
                </div>
                ...
                <button @click="darkMode = !darkMode; localStorage.setItem('theme', darkMode ? 'dark' : 'light')"
                    ...
                    <span x-text="darkMode ? @js(__('app.light_theme')) : @js(__('app.dark_theme'))"></span>
                </button>
            </aside>
            ...
            <main class="flex-1 p-6 lg:p-10 overflow-y-auto max-h-[85vh] bg-white dark:bg-slate-800">
                ...
                <div x-show="loading" class="flex flex-col items-center justify-center py-20">
                    ...
                    <p class="mt-4 text-gray-500 dark:text-gray-400">{{ __('app.loading') }}</p>
                </div>
                ...
                <div x-show="!loading" class="flex items-center justify-between mt-10 pt-6 border-t border-gray-100 dark:border-slate-700">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="saveAndNext()"
                            ...
                            <span x-show="!saving" x-text="isLastStep() ? @js(__('app.finish')) : @js(__('app.continue'))"></span>
                ...
                async saveAndNext() {
                    ...
                    try {
                        ...
                        if (!response.ok) {
                            ...
                            this.serverError = {
                                title: @js(__('app.validation_error')),
                                message: errorData.message || @js(__('app.check_data_correctness')),
                        ...
                        if (data.success) {
                            ...
                            if (data.completed) {
                                this.successMessage = @js(__('app.setup_completed'));
                                this.celebrate();
                                setTimeout(() => {
                                    window.location.href = data.redirect;
                                }, 2500);
                            } else if (data.nextStep) {
                                this.successMessage = @js(__('app.saved'));
                        ...
                        this.serverError = {
                            title: @js(__('app.connection_error')),
                            message: @js(__('app.check_internet_connection'))
                        };
