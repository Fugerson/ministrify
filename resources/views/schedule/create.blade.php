...
<div class="max-w-2xl mx-auto">
    <form method="POST" action="{{ route('events.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Нова подія</h2>
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Назва *</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="time" class="block text-sm font-medium text-gray-700 mb-1">Час *</label>
                ...
                <div>
                    <label for="recurrence_rule" class="block text-sm font-medium text-gray-700 mb-1">Повторення</label>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('schedule') }}" class="px-4 py-2 text-gray-700 hover:text-gray-900">
                Скасувати
            </a>
