                                ...
                                <tr class="hover:bg-blue-50/50 dark:hover:bg-gray-700/50 group" data-id="{{ $item->id }}">
                                    ...
                                    <td class="px-3 py-3 border-r border-gray-100 dark:border-gray-700">
                                        <input type="time"
                                               ...
                                               class="w-20 px-1 py-1 text-sm font-semibold text-primary-600 dark:text-primary-400 bg-transparent border-0 focus:ring-1 focus:ring-primary-500 rounded cursor-pointer">
                                    </td>
                                    {{-- Що відбувається --}}
                                    <td class="px-3 py-3 border-r border-gray-100 dark:border-gray-700">
                                        <input type="text"
