            ...
            @foreach($posts as $post)
                <div class="flex items-center gap-4 p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <div class="flex gap-1">
                        ...
                        <button type="button" @click="ajaxDelete('{{ route('website-builder.blog.destroy', $post) }}', '{{ __('messages.confirm_delete_article') }}', () => $el.closest('.flex.items-center.gap-4').remove())" class="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
