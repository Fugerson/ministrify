                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex items-start gap-4 mb-4">
                        <div class="w-12 h-12 rounded-full bg-gray-200 dark:bg-gray-700 flex-shrink-0 overflow-hidden">
                            @if($testimonial->author_photo)
                                <img src="{{ Storage::url($testimonial->author_photo) }}" alt="{{ $testimonial->author_name }}" class="w-full h-full object-cover" loading="lazy">
                            @else
                    ...
                    <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex gap-1">
                            ...
                            <button type="button" @click="ajaxDelete('{{ route('website-builder.testimonials.destroy', $testimonial) }}', @js( __('messages.confirm_delete_testimony') ), () => $el.closest('.bg-white, .dark\\:bg-gray-800').remove())" class="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
