                    ...
                    <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button" @click="ajaxDelete('{{ route('website-builder.prayer-inbox.destroy', $request) }}', @js( __('messages.confirm_delete_prayer_request') ), () => $el.closest('.p-6').remove())" class="p-2 text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors">
