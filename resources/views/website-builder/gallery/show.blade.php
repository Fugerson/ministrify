            ...
            @foreach($photos as $photo)
                <div class="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                        <button type="button" @click="ajaxDelete('{{ route('website-builder.gallery.photos.delete', $photo) }}', @js( __('messages.confirm_delete_photo') ), () => $el.closest('.group').remove())" class="p-1.5 bg-red-500/80 hover:bg-red-600 text-white rounded-lg transition-colors">
