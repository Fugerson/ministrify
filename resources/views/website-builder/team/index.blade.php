                    ...
                    <li class="team-item" data-id="{{ $member->id }}">
                        <div class="flex items-center gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button" @click="ajaxDelete('{{ route('website-builder.team.destroy', $member) }}', '{{ __('messages.confirm_remove_member') }}', () => $el.closest('.team-item').remove())" class="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
