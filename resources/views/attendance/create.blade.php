...
<div class="max-w-3xl mx-auto">
    <form method="POST" action="{{ route('attendance.store') }}" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            ...
            @if($event)
                ...
                <div class="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <p class="font-medium text-gray-900 dark:text-white">{{ $event->ministry->icon }} {{ $event->ministry->name }}</p>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    <label for="total_count" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Загальна кількість *</label>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Відмітити присутність</h3>
        ...
        <div class="flex items-center justify-end space-x-4">
            <a href="{{ route('attendance.index') }}" class="px-4 py-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                Скасувати
            </a>
