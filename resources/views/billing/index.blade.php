            ...
            @foreach($plans as $plan)
                ...
                <div class="relative rounded-xl border-2 {{ $isCurrent ? 'border-primary-500' : 'border-gray-200 dark:border-gray-700' }} p-6">
                    ...
                    <ul class="space-y-2 mb-6">
                        ...
                        <li class="flex items-center text-sm">
                            <svg class="w-4 h-4 mr-2 {{ $plan->has_boards ? 'text-green-500' : 'text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                                @if($plan->has_boards)
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/>
                                @else
                                    <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                            ...
                            <span class="{{ $plan->has_boards ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400' }}">
                                Трекер завдань
                            </span>
                        </li>
                    </ul>
