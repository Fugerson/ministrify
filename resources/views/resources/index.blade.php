...
<div class="space-y-6" x-data="resourcesManager()">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ресурси</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <table class="w-full">
            <thead class="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase whitespace-nowrap">Назва</th>
    ...
    <div x-show="showCreateFolder" x-cloak class="fixed inset-0 z-50 overflow-y-auto">
        <div class="min-h-screen px-4 flex items-center justify-center">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full p-6">
                ...
                <form method="POST" action="{{ route('resources.folder.create') }}">
                    @csrf
    ...
    <form id="uploadForm" method="POST" action="{{ route('resources.upload') }}" enctype="multipart/form-data" class="hidden">
        @csrf
        <input type="hidden" name="parent_id" value="{{ $folder?->id }}">
