            ...
            @php
                $faqs = [
                    [
                        ...
                        'a' => 'Ministrify — це сучасна українська платформа для управління церквою. Вона допомагає вести облік членів, планувати події та команди, керувати фінансами, організовувати групи та багато іншого.'
                    ],
                    [
