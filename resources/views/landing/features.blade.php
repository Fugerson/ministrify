...
@section('title', __('Можливості — Ministrify | Функції системи управління церквою'))
@section('description', __('Повний список можливостей Ministrify: управління членами, події, пожертви, групи, команди, Telegram бот, звіти та багато іншого.'))
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                {{ __('Все необхідне для вашої церкви') }}
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                {{ __('Потужні інструменти, прості у використанні. Створено спеціально для потреб українських церков.') }}
            </p>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Зручний дашборд') }}</h2>
            <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('Вся важлива інформація на одному екрані') }}</p>
        </div>
        ...
        <div class="space-y-32">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Повна база ваших людей') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Зберігайте всю інформацію про членів церкви в одному місці. Контакти, сім\'ї, дні народження, участь у командах.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            {{ __('Детальні профілі з фото') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Зв\'язки сімей та опікуни') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Теги, фільтрація та пошук') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Імпорт з Excel/CSV') }}
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_2.jpg" alt="{{ __('Управління членами церкви') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1 relative">
                    ...
                    <div class="relative bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_3.jpg" alt="{{ __('Фінансовий облік церкви') }}" class="rounded-xl w-full">
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Повний фінансовий облік') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Ведіть облік пожертв, десятин та витрат. Детальні звіти по категоріях та командах. Бюджетування та аналітика.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Десятини та пожертви') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Витрати по командах') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Графіки та динаміка') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Експорт в CSV/Excel') }}
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Події та розклад') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Плануйте богослужіння, зустрічі груп та заходи. Автоматичні нагадування та синхронізація з Google Calendar.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Візуальний календар') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Призначення волонтерів') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_4.jpg" alt="{{ __('Календар подій церкви') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1 relative">
                    ...
                    <div class="relative bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_5.jpg" alt="{{ __('Команди служіння') }}" class="rounded-xl w-full">
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Команди служіння') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Організуйте команди служіння, призначайте лідерів та учасників. Відстежуйте активність та плануйте ротацію.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Трекер завдань') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Kanban-дошка для планування та відстеження завдань команд. Пріоритети, дедлайни, виконавці.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        ...
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Пріоритети та дедлайни') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Фільтри по командах') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Коментарі та вкладення') }}
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-indigo-500 to-violet-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_6.jpg" alt="{{ __('Трекер завдань') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl p-1">
                        <div class="bg-white dark:bg-gray-900 rounded-xl p-8 aspect-video flex items-center justify-center">
                            <div class="text-center">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">{{ __('Telegram бот') }}</h3>
                                <p class="text-gray-500 dark:text-gray-400">{{ __('Сповіщення та комунікація') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Telegram бот для церкви') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('Автоматичні сповіщення волонтерам, нагадування про події, масові розсилки та індивідуальні повідомлення.') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Власний бот церкви') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Нагадування про події') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('Масові розсилки') }}
...
<section class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('І ще багато іншого') }}</h2>
            <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('Все що потрібно для ефективного управління церквою') }}</p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {{-- Малі групи --}}
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Малі групи') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('Домашні групи, лідери, відвідуваність та статистика') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Відвідуваність') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('Облік відвідуваності богослужінь та груп з аналітикою') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Звіти') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('Детальна аналітика, графіки та експорт даних') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Ресурси') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('Файлове сховище для документів, презентацій та медіа') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Комунікації') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('Оголошення, приватні повідомлення та масові розсилки') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('Мобільна версія') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('PWA додаток — працює на телефоні як нативний застосунок') }}</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('Гнучкі налаштування') }}</h2>
                <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                    {{ __('Повний контроль над системою: права доступу, категорії, інтеграції та персоналізація під вашу церкву.') }}
                </p>
                <ul class="space-y-3">
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('Права доступу по ролях') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('Церковні ролі та опікуни') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('Категорії фінансів') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('Інтеграція з Google та Telegram') }}
                    </li>
                </ul>
            </div>
            <div class="relative">
                ...
                <div class="relative bg-gradient-to-br from-gray-500 to-slate-600 rounded-2xl p-1 shadow-xl">
                    <img src="/icons/demo/Screenshot_8.jpg" alt="{{ __('Налаштування системи') }}" class="rounded-xl w-full">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-gradient-to-br from-primary-600 to-primary-700">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">{{ __('Готові почати?') }}</h2>
        <p class="text-xl text-primary-100 mb-8">{{ __('Спробуйте безкоштовно — без зобов\'язань та обмежень на час.') }}</p>
