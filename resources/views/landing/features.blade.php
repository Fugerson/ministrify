    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                {{ __('landing.everything_needed') }}
            </h1>
            <p class="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                {{ __('landing.powerful_tools') }}
            </p>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.convenient_dashboard') }}</h2>
            <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('landing.important_info_screen') }}</p>
        </div>
        ...
        <div class="space-y-32">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="inline-flex items-center px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-medium mb-4">
                        ...
                        {{ __('landing.church_members') }}
                    </div>
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.complete_database') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.members_storage') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            {{ __('landing.detailed_profiles') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.family_connections') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.tags_filtering') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.import_excel') }}
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_2.jpg" alt="{{ __('landing.manage_members_title') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1 relative">
                    ...
                    <div class="relative bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_3.jpg" alt="{{ __('landing.finance_accounting') }}" class="rounded-xl w-full">
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.complete_accounting') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.accounting_description') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.tithes_donations') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.expenses_by_teams') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.charts_dynamics') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.export_csv') }}
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="inline-flex items-center px-3 py-1 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-sm font-medium mb-4">
                        ...
                        {{ __('landing.calendar_events') }}
                    </div>
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.events_schedule') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.calendar_description') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.visual_calendar') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.volunteer_assignment') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        ...
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.attendance_tracking') }}
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_4.jpg" alt="{{ __('landing.event_calendar_title') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="order-2 lg:order-1 relative">
                    ...
                    <div class="relative bg-gradient-to-br from-orange-500 to-amber-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_5.jpg" alt="{{ __('landing.ministry_teams') }}" class="rounded-xl w-full">
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    <div class="inline-flex items-center px-3 py-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-sm font-medium mb-4">
                        ...
                        {{ __('landing.teams_section') }}
                    </div>
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.ministry_teams') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.teams_description') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.positions_roles') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.team_leaders') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.goals_tasks') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.team_budget') }}
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <div class="inline-flex items-center px-3 py-1 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 text-sm font-medium mb-4">
                        ...
                        {{ __('landing.tasks_section') }}
                    </div>
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.task_tracker_title') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.tasks_description') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.kanban_board') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.priorities_deadlines') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.filters_by_teams') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.comments_attachments') }}
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    ...
                    <div class="relative bg-gradient-to-br from-indigo-500 to-violet-600 rounded-2xl p-1 shadow-xl">
                        <img src="/icons/demo/Screenshot_6.jpg" alt="{{ __('landing.task_tracker_title') }}" class="rounded-xl w-full">
                    </div>
                </div>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl p-1">
                        <div class="bg-white dark:bg-gray-900 rounded-xl p-8 aspect-video flex items-center justify-center">
                            <div class="text-center">
                                ...
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">{{ __('landing.telegram_bot_section') }}</h3>
                                <p class="text-gray-500 dark:text-gray-400">{{ __('landing.notifications_communication') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.telegram_bot_church') }}</h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                        {{ __('landing.notifications_description') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        ...
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.event_reminders') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.mass_mailings') }}
                        </li>
                        <li class="flex items-center text-gray-700 dark:text-gray-300">
                            <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                            {{ __('landing.confirmation_participation') }}
                        </li>
                    </ul>
                </div>
            </div>
...
<section class="py-20 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.much_more') }}</h2>
            <p class="text-lg text-gray-600 dark:text-gray-400">{{ __('landing.all_for_church') }}</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.small_groups') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.groups_leaders') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.attendance_section') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.attendance_analytics') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.reports_section') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.reports_description') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.resources_section') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.resources_description') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.communications_section') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.communications_description') }}</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">{{ __('landing.mobile_version') }}</h3>
                <p class="text-gray-600 dark:text-gray-400">{{ __('landing.pwa_app') }}</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-medium mb-4">
                    ...
                    {{ __('landing.flexible_settings') }}
                </div>
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">{{ __('landing.flexible_settings') }}</h2>
                <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">
                    {{ __('landing.flexible_settings') }}
                </p>
                <ul class="space-y-3">
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('landing.access_rights_roles') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('landing.church_roles') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        {{ __('landing.finance_categories') }}
                    </li>
                    <li class="flex items-center text-gray-700 dark:text-gray-300">
                        <svg class="w-5 h-5 text-green-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
            ...
            <div class="relative">
                ...
                <div class="relative bg-gradient-to-br from-gray-500 to-slate-600 rounded-2xl p-1 shadow-xl">
                    <img src="/icons/demo/Screenshot_8.jpg" alt="{{ __('landing.system_settings_title') }}" class="rounded-xl w-full">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-gradient-to-br from-primary-600 to-primary-700">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">{{ __('landing.ready_start') }}</h2>
        <p class="text-xl text-primary-100 mb-8">{{ __('landing.try_free') }}</p>
