...
<head>
    ...
    <title>{{ config('app.name', 'Ministrify') }} - @yield('title', __('Вхід'))</title>
    ...
    <div class="min-h-screen flex flex-col justify-center px-4 py-8 sm:py-12">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="mt-1 text-gray-500 dark:text-gray-400">{{ __('Управління церквою просто') }}</p>
            </div>
            ...
            <div class="mt-8 text-center space-y-4">
                ...
                <div class="flex items-center justify-center gap-3">
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-400">{{ __('Тема:') }}</span>
                    <div class="flex items-center bg-gray-200 dark:bg-gray-700 rounded-lg p-1">
                        <button @click="darkMode = false; localStorage.setItem('theme', 'light')"
                                ...
                                class="p-1.5 rounded-md transition-all" title="{{ __('Світла тема') }}">
                        ...
                        <button @click="darkMode = true; localStorage.setItem('theme', 'dark')"
                                :class="darkMode ? 'bg-white dark:bg-gray-600 shadow' : ''"
                                class="p-1.5 rounded-md transition-all" title="{{ __('Темна тема') }}">
                ...
                <p class="text-sm text-gray-400 dark:text-gray-500">
                    &copy; {{ date('Y') }} Ministrify. {{ __('Для церков України') }}
                </p>
            </div>
        </div>
    </div>
