...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <div x-data="{ sidebarOpen: false }" class="min-h-screen flex {{ session('impersonating_from') ? 'pt-10' : '' }}"
        ...
        <div class="flex-1 lg:pl-64 overflow-x-hidden">
            <!-- Mobile Header -->
            <header class="lg:hidden sticky {{ session('impersonating_from') ? 'top-14' : 'top-0' }} z-30 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm safe-top">
            ...
            <!-- Desktop Header -->
            <header class="hidden lg:flex sticky {{ session('impersonating_from') ? 'top-14' : 'top-0' }} z-30 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 items-center justify-between h-16 px-6">
