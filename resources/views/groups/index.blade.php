...
<div class="space-y-8">
    ...
    <div id="groups-stats" class="grid grid-cols-3 gap-2 sm:gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-5">
            <div class="flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left">
                ...
                <div class="mt-2 sm:mt-0 sm:ml-4">
                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{{ $groups->count() }}</p>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('app.group_total_groups') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-5">
            <div class="flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left">
                ...
                <div class="mt-2 sm:mt-0 sm:ml-4">
                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{{ $groups->sum('members_count') }}</p>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('app.group_total_members') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-5">
            <div class="flex flex-col sm:flex-row items-center sm:items-center text-center sm:text-left">
                ...
                <div class="mt-2 sm:mt-0 sm:ml-4">
                    <p class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">{{ $groups->count() > 0 ? round($groups->sum('members_count') / $groups->count(), 1) : 0 }}</p>
                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ __('app.group_avg_size') }}</p>
                </div>
            </div>
        </div>
    </div>
