...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @forelse($templates as $template)
            <div data-template class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
                <div class="p-5">
                    <div class="flex items-start justify-between">
                        ...
                        <div class="flex items-center gap-1">
                            ...
                            <button type="button"
                                    @click="ajaxDelete('{{ route('checklists.templates.destroy', $template) }}', @js( __('messages.confirm_delete_template') ), () => $el.closest('[data-template]').remove())"
