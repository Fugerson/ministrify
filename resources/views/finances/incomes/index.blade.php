                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($incomes as $income)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            ...
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-sm font-semibold text-green-600 dark:text-green-400 text-right">
                                +{{ number_format($income->amount, 0, ',', ' ') }} ₴
                            </td>
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-sm">
                                <a href="{{ route('finances.incomes.edit', $income) }}" class="p-1.5 inline-flex text-primary-600 dark:text-primary-400 hover:text-primary-900 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-lg">
