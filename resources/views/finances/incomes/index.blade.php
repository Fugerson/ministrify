...
<div class="flex items-center space-x-2">
    <button type="button" onclick="alert('CLICK WORKS'); event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('open-income-modal')); return false;"
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50" data-income-id="{{ $income->id }}">
                            ...
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex items-center justify-end gap-1">
                                    <button type="button" onclick="event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('edit-income', {detail: {{ $income->id }}})); return false;"
                                    ...
                                    <button type="button" onclick="alert('DELETE CLICK'); event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('delete-income', {detail: {{ $income->id }}})); return false;"
...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('incomesManager', () => ({
        ...
        init() {
            ...
            document.addEventListener('edit-income', (e) => {
                console.log('[DEBUG] edit-income event received', e.detail);
                this.openEdit(e.detail);
            });
            document.addEventListener('delete-income', (e) => {
                console.log('[DEBUG] delete-income event received', e.detail);
