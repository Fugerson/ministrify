                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50" data-income-id="{{ $income->id }}">
                            ...
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button type="button" onclick="event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('delete-income', {detail: {{ $income->id }}})); return false;"
