                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50" data-expense-id="{{ $expense->id }}">
                            ...
                            <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex items-center justify-end gap-1">
                                    <button type="button" onclick="event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('edit-expense', {detail: {{ $expense->id }}})); return false;"
                                    ...
                                    <button type="button" onclick="event.preventDefault(); event.stopPropagation(); document.dispatchEvent(new CustomEvent('delete-expense', {detail: {{ $expense->id }}})); return false;"
    ...
    Alpine.data('expensesManager', () => ({
        ...
        init() {
            ...
            document.addEventListener('edit-expense', (e) => {
                console.log('[DEBUG] edit-expense event received', e.detail);
                this.openEdit(e.detail);
            });
            document.addEventListener('delete-expense', (e) => {
                console.log('[DEBUG] delete-expense event received', e.detail);
