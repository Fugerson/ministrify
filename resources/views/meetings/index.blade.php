...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $meetings->total() }}</p>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Всього зустрічей</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Заплановано</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">Проведено</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $thisMonth }}</p>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Цього місяця</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 mb-6">Створіть першу зустріч для служіння</p>
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <a href="{{ route('meetings.show', [$ministry, $meeting]) }}" class="block p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <!-- Date badge -->
                        <div class="w-14 h-14 rounded-xl bg-gray-100 dark:bg-gray-700 flex flex-col items-center justify-center flex-shrink-0">
                            <span class="text-xs text-gray-500 dark:text-gray-400 uppercase">{{ $meeting->date->translatedFormat('M') }}</span>
                            <span class="text-xl font-bold text-gray-900 dark:text-white">{{ $meeting->date->format('d') }}</span>
                        </div>

                        <div>
                            <div class="flex items-center gap-2">
                                <h3 class="font-semibold text-gray-900 dark:text-white">{{ $meeting->title }}</h3>
                                @php
                                    $statusColors = [
                                ...
                                @endphp
                                <span class="px-2 py-0.5 text-xs font-medium rounded-full {{ $statusColors[$meeting->status] }}">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="text-center">
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">{{ $meeting->agendaItems->count() }}</span>
                            <p class="text-xs text-gray-500 dark:text-gray-400">пунктів</p>
                        </div>
                        <!-- Attendees count -->
                        <div class="text-center">
                            <span class="text-lg font-semibold text-gray-900 dark:text-white">{{ $meeting->attendees->count() }}</span>
