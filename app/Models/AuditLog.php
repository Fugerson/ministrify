...
class AuditLog extends Model
{
    ...
    public function getActionLabelAttribute(): string
    {
        return match($this->action) {
            ...
            'restored' => __('app.audit_action_restored'),
            'login' => __('app.audit_action_login'),
            'logout' => __('app.audit_action_logout'),
            'registered' => __('app.audit_action_registered'),
            'joined_church' => __('app.audit_action_joined_church'),
            'exported' => __('app.audit_action_exported'),
            'imported' => __('app.audit_action_imported'),
            'sent' => __('app.audit_action_sent'),
            'impersonate' => __('app.audit_action_impersonate'),
            'stop_impersonate' => __('app.audit_action_stop_impersonate'),
            'assigned' => __('app.audit_action_assigned'),
            'unassigned' => __('app.audit_action_unassigned'),
            'approved' => __('app.audit_action_approved'),
            'rejected' => __('app.audit_action_rejected'),
            'completed' => __('app.audit_action_completed'),
            // Custom actions
            'member_added' => __('app.audit_action_member_added'),
            'member_removed' => __('app.audit_action_member_removed'),
            'member_role_changed' => __('app.audit_action_member_role_changed'),
            'bulk_action' => __('app.audit_action_bulk_action'),
            'bulk_deleted' => __('app.audit_action_bulk_deleted'),
            'bulk_ministry_assigned' => __('app.audit_action_bulk_ministry_assigned'),
            'bulk_tag_assigned' => __('app.audit_action_bulk_tag_assigned'),
            'bulk_message_sent' => __('app.audit_action_bulk_message_sent'),
            'bulk_access_granted' => __('app.audit_action_bulk_access_granted'),
            'password_reset' => __('app.audit_action_password_reset'),
            'account_created' => __('app.audit_action_account_created'),
            'telegram_linked' => __('app.audit_action_telegram_linked'),
            'telegram_unlinked' => __('app.audit_action_telegram_unlinked'),
            'attendance_saved' => __('app.audit_action_attendance_saved'),
            'calendar_synced' => __('app.audit_action_calendar_synced'),
            'settings_updated' => __('app.audit_action_settings_updated'),
            'notification_settings_updated' => __('app.audit_action_notification_settings_updated'),
            'payment_settings_updated' => __('app.audit_action_payment_settings_updated'),
            'finance_settings_updated' => __('app.audit_action_finance_settings_updated'),
            'currency_settings_updated' => __('app.audit_action_currency_settings_updated'),
            'theme_updated' => __('app.audit_action_theme_updated'),
            'public_site_updated' => __('app.audit_action_public_site_updated'),
            'photo_uploaded' => __('app.audit_action_photo_uploaded'),
            'photo_deleted' => __('app.audit_action_photo_deleted'),
            'positions_updated' => __('app.audit_action_positions_updated'),
            'quick_edit_saved' => __('app.audit_action_quick_edit_saved'),
            'visibility_updated' => __('app.audit_action_visibility_updated'),
            'privacy_toggled' => __('app.audit_action_privacy_toggled'),
            'checklist_created' => __('app.audit_action_checklist_created'),
            'checklist_item_toggled' => __('app.audit_action_checklist_item_toggled'),
            'plan_item_added' => __('app.audit_action_plan_item_added'),
            'plan_item_reordered' => __('app.audit_action_plan_item_reordered'),
            'notification_sent' => __('app.audit_action_notification_sent'),
            'role_changed' => __('app.audit_action_role_changed'),
            'email_changed' => __('app.audit_action_email_changed'),
            'shepherd_assigned' => __('app.audit_action_shepherd_assigned'),
            'google_calendar_connected' => __('app.audit_action_google_calendar_connected'),
            'google_calendar_disconnected' => __('app.audit_action_google_calendar_disconnected'),
            'monobank_synced' => __('app.audit_action_monobank_synced'),
            'privatbank_synced' => __('app.audit_action_privatbank_synced'),
