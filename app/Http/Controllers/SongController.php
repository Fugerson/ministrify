...
class SongController extends Controller
{
    ...
    public function update(Request $request, Song $song)
    {
        ...
        broadcast(new ChurchDataUpdated($song->church_id, 'service-planning', 'updated'))->toOthers();
    ...
    public function destroy(Request $request, Song $song)
    {
        ...
        broadcast(new ChurchDataUpdated($churchId, 'service-planning', 'updated'))->toOthers();
