    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($groups->count()); ?></p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($groups->sum('members_count')); ?></p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-5">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($groups->count() > 0 ? round($groups->sum('members_count') / $groups->count(), 1) : 0); ?></p>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        <td class="px-3 md:px-6 py-3 md:py-4">
                            <a href="<?php echo e(route('groups.show', $group)); ?>" class="flex items-center group">
                                ...
                                <div class="ml-3 min-w-0">
                                    <p class="text-sm font-semibold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 truncate"><?php echo e($group->name); ?></p>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 truncate max-w-[150px] sm:max-w-xs hidden sm:block"><?php echo e(Str::limit($group->description, 50)); ?></p>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <!-- Mobile: show leader under name -->
                                    <p class="md:hidden text-xs text-gray-400 dark:text-gray-500 mt-0.5"><?php echo e($group->leader?->full_name ?? ''); ?></p>
                                </div>
                            </a>
                        </td>
                        <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap hidden md:table-cell">
                            ...
                            <a href="<?php echo e(route('people.show', $group->leader)); ?>" class="text-sm text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400">
                                <?php echo e($group->leader->full_name); ?>
                        ...
                        <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-center hidden sm:table-cell">
                            <span class="inline-flex items-center gap-1.5 px-2 md:px-2.5 py-1 rounded-lg text-xs font-medium
                                <?php if($group->status === 'active'): ?> bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300
                                <?php elseif($group->status === 'paused'): ?> bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300
                                <?php else: ?> bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300
                                <?php endif; ?>">
                                <span class="w-1.5 h-1.5 rounded-full
                                    <?php if($group->status === 'active'): ?> bg-green-500
                                    <?php elseif($group->status === 'paused'): ?> bg-yellow-500
                                    <?php else: ?> bg-blue-500
                                    <?php endif; ?>"></span>
                                <span class="hidden md:inline"><?php echo e($group->status_label); ?></span>
                            </span>
                        </td>
                        ...
                        <td class="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-right">
                            <a href="<?php echo e(route('groups.show', $group)); ?>" class="p-1.5 inline-flex text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 hover:bg-primary-50 dark:hover:bg-primary-900/20 rounded-lg">
