<?php $__env->startSection('title', 'Ministrify — Система управління церквою | Українська CRM для церков'); ?>
<?php $__env->startSection('description', 'Безкоштовна українська платформа для управління церквою: члени, події, пожертви, групи, служіння. Інтеграція з LiqPay, Monobank та Telegram.'); ?>
<?php $__env->startSection('keywords', 'церква, управління церквою, church management, CRM для церкви, пожертви онлайн, облік членів церкви, українська CRM, безкоштовно'); ?>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="<?php echo e(url('/register-church')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-primary-600/25 hover:shadow-primary-600/40 hover:scale-105">
                        <span>Почати безкоштовно</span>
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                        </svg>
                    </a>
                    <a href="<?php echo e(url('/features')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-semibold rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-600 transition-all hover:scale-105">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6 aspect-video">
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-4">
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm">
                                <div class="text-2xl font-bold text-primary-600"><?php echo e($stats['members'] ?? '247'); ?></div>
                                <div class="text-xs text-gray-500">Членів</div>
                            </div>
                            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm">
                                <div class="text-2xl font-bold text-green-600"><?php echo e($stats['events'] ?? '12'); ?></div>
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm h-32">
                            ...
                            <div class="flex items-end space-x-1 h-16">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [40, 55, 45, 60, 75, 65, 80, 70, 85, 78, 90, 88]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex-1 bg-primary-500/80 rounded-t" style="height: <?php echo e($h); ?>%"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    Організуйте служіння, домашні групи та команди. Відстежуйте участь та координуйте волонтерів.
                </p>
            </div>
        ...
        <div class="text-center mt-12">
            <a href="<?php echo e(url('/features')); ?>" class="inline-flex items-center text-primary-600 dark:text-primary-400 font-semibold hover:text-primary-700 dark:hover:text-primary-300">
                Всі можливості
...
<section class="py-16 bg-gradient-to-r from-primary-600 to-purple-600">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
                <div class="text-4xl md:text-5xl font-bold text-white mb-2"><?php echo e($stats['churches'] ?? '10'); ?>+</div>
                <div class="text-primary-100">Церков</div>
            </div>
            <div>
                <div class="text-4xl md:text-5xl font-bold text-white mb-2"><?php echo e(number_format($stats['members'] ?? 500)); ?>+</div>
                <div class="text-primary-100">Членів</div>
            </div>
            <div>
                <div class="text-4xl md:text-5xl font-bold text-white mb-2"><?php echo e($stats['events'] ?? '100'); ?>+</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-600 transition-all hover:shadow-lg">
                ...
                <a href="<?php echo e(url('/register-church')); ?>" class="block w-full py-3 px-4 text-center bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                    Почати безкоштовно
                </a>
            </div>
            ...
            <div class="bg-primary-600 rounded-2xl p-8 relative transform md:scale-105 shadow-xl shadow-primary-600/25">
                ...
                <a href="<?php echo e(url('/register-church')); ?>" class="block w-full py-3 px-4 text-center bg-white text-primary-600 font-semibold rounded-xl hover:bg-primary-50 transition-colors">
                    Обрати план
                </a>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary-300 dark:hover:border-primary-600 transition-all hover:shadow-lg">
                ...
                <a href="<?php echo e(url('/contact')); ?>" class="block w-full py-3 px-4 text-center bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 font-semibold rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
                    Зв'язатися
                </a>
            </div>
        </div>
...
<section class="py-20 bg-white dark:bg-gray-950">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(url('/register-church')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-xl transition-all shadow-lg shadow-primary-600/25 hover:shadow-primary-600/40">
                Почати безкоштовно
                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                </svg>
            </a>
            <a href="<?php echo e(url('/contact')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 font-semibold rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-all">
                Запитати демо
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/landing/home.blade.php ENDPATH**/ ?>