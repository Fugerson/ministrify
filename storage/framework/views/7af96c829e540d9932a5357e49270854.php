...
<div class="space-y-4 lg:space-y-6 page-transition">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mt-4 lg:mt-6">
        <div class="px-4 lg:px-5 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('boards.index')); ?>" class="text-sm text-primary-600 dark:text-primary-400 hover:underline flex items-center gap-1">
                Всі завдання
        ...
        <div class="p-4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $urgentTasks->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('boards.index', ['card' => $task->id])); ?>"
                   class="block bg-gray-50 dark:bg-gray-700/50 border-l-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 overflow-hidden
                          <?php echo e($task->priority === 'urgent' ? 'border-l-red-500' : ($task->priority === 'high' ? 'border-l-orange-500' : 'border-l-yellow-500')); ?>">
                    <div class="p-3">
                        <!-- Title -->
                        <h4 class="font-medium text-sm text-gray-900 dark:text-white line-clamp-2 mb-2"><?php echo e($task->title); ?></h4>
                        ...
                        <div class="flex items-center gap-1.5 mb-2">
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                                <?php echo e($task->column->name); ?>

                            </span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->priority === 'urgent'): ?>
                        ...
                        <div class="flex items-center justify-between text-xs">
                            ...
                            <span class="flex items-center gap-1 <?php echo e($task->isOverdue() ? 'text-red-500 font-medium' : 'text-gray-500 dark:text-gray-400'); ?>">
                            ...
                            <div class="w-6 h-6 rounded-full bg-primary-100 dark:bg-primary-900 flex items-center justify-center" title="<?php echo e($task->assignee->full_name); ?>">
                                <span class="text-[10px] font-medium text-primary-600 dark:text-primary-400"><?php echo e(mb_substr($task->assignee->first_name, 0, 1)); ?></span>
                            </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
            ...
            <a href="<?php echo e(route('boards.index')); ?>" class="block text-center py-3 mt-3 text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 border-t border-gray-100 dark:border-gray-700">
                + ще <?php echo e(count($urgentTasks) - 5); ?> завдань
            </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <?php else: ?>
        <div class="p-8 text-center">
            ...
            <a href="<?php echo e(route('boards.index')); ?>" class="inline-block mt-2 text-sm text-primary-600 dark:text-primary-400 hover:underline">
                Перейти до трекера
            </a>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
