<?php $__env->startSection('title', 'Оголошення'); ?>
...
<a href="<?php echo e(route('announcements.create')); ?>" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-xl">
    + Нове оголошення
</a>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-primary-600 dark:text-primary-400"><?php echo e($unreadCount); ?> нових</p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
    ...
    <div class="space-y-4">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            ?>
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden <?php echo e($isUnread ? 'ring-2 ring-primary-500' : ''); ?>">
                <!-- Pinned Badge -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($announcement->is_pinned): ?>
                ...
                <a href="<?php echo e(route('announcements.show', $announcement)); ?>" class="block p-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    <div class="flex items-start justify-between">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white <?php echo e($isUnread ? 'text-primary-600 dark:text-primary-400' : ''); ?>">
                ...
                <div class="px-6 py-3 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-100 dark:border-gray-700 flex items-center gap-2">
                    <form action="<?php echo e(route('announcements.pin', $announcement)); ?>" method="POST" class="inline">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="text-sm text-gray-500 hover:text-amber-600 dark:text-gray-400 dark:hover:text-amber-400">
                            <?php echo e($announcement->is_pinned ? 'Відкріпити' : 'Закріпити'); ?>

                        </button>
                    </form>
                    <span class="text-gray-300 dark:text-gray-600">|</span>
                    <a href="<?php echo e(route('announcements.edit', $announcement)); ?>" class="text-sm text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400">
                        Редагувати
                    </a>
                    <span class="text-gray-300 dark:text-gray-600">|</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/announcements/index.blade.php ENDPATH**/ ?>