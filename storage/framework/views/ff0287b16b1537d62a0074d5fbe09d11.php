...
<form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-primary-600 hover:text-primary-700 font-medium">
            Забули пароль?
        </a>
    </div>
...
<div class="mt-8 pt-6 border-t border-gray-100 text-center">
    ...
    <a href="<?php echo e(route('register')); ?>" class="mt-2 inline-flex items-center text-primary-600 hover:text-primary-700 font-semibold">
