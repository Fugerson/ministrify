...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div x-show="activeTab === 'finance'" x-cloak class="space-y-6">
        <!-- Initial Balance -->
        <form method="POST" action="<?php echo e(route('settings.finance')); ?>" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="initial_balance" id="initial_balance" step="0.01" min="0" required
                                   value="<?php echo e(old('initial_balance', $church->initial_balance ?? 0)); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['initial_balance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="date" name="initial_balance_date" id="initial_balance_date" required
                               value="<?php echo e(old('initial_balance_date', $church->initial_balance_date?->format('Y-m-d') ?? now()->format('Y-m-d'))); ?>"
                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['initial_balance_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($church->initial_balance && $church->initial_balance_date): ?>
                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e(number_format($church->initial_balance, 0, ',', ' ')); ?> ₴</p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase">Доходи</p>
                            <p class="text-lg font-semibold text-green-600 dark:text-green-400">+<?php echo e(number_format($church->total_income, 0, ',', ' ')); ?> ₴</p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase">Витрати</p>
                            <p class="text-lg font-semibold text-red-600 dark:text-red-400">-<?php echo e(number_format($church->total_expense, 0, ',', ' ')); ?> ₴</p>
                        </div>
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase">Поточний</p>
                            <p class="text-lg font-semibold text-primary-600 dark:text-primary-400"><?php echo e(number_format($church->current_balance, 0, ',', ' ')); ?> ₴</p>
                        </div>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
