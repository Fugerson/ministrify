<?php $__env->startSection('title', 'Ротація служительів'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-help','data' => ['page' => 'rotation']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page' => 'rotation']); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-5">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 rounded-xl flex items-center justify-center" style="background-color: <?php echo e($ministry->color ?? '#3b82f6'); ?>20;">
                        <div class="w-4 h-4 rounded-full" style="background-color: <?php echo e($ministry->color ?? '#3b82f6'); ?>"></div>
                    </div>
                    <div>
                        <h3 class="font-semibold text-gray-900 dark:text-white"><?php echo e($ministry->name); ?></h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($ministry->members_count); ?> учасників</p>
                    </div>
                </div>

                <!-- Upcoming Events Preview -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($upcomingEvents[$ministry->id]) && $upcomingEvents[$ministry->id]->count() > 0): ?>
                <div class="space-y-2 mb-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $upcomingEvents[$ministry->id]->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center justify-between p-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                        <div class="min-w-0">
                            <p class="text-sm font-medium text-gray-900 dark:text-white truncate"><?php echo e($event->title); ?></p>
                            <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($event->date->format('d.m')); ?></p>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <div class="w-16 h-2 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                                <div class="h-full rounded-full <?php echo e($percentage >= 100 ? 'bg-green-500' : ($percentage >= 50 ? 'bg-amber-500' : 'bg-red-500')); ?>"
                                     style="width: <?php echo e(min(100, $percentage)); ?>%"></div>
                            </div>
                            <span class="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap"><?php echo e($filled); ?>/<?php echo e($total); ?></span>
                        </div>
                    </div>
                ...
                <div class="flex gap-2">
                    <a href="<?php echo e(route('rotation.ministry', $ministry)); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($upcomingEvents[$ministry->id]) && $upcomingEvents[$ministry->id]->count() > 0): ?>
                    <button type="button"
                            onclick="autoAssignMinistry(<?php echo e($ministry->id); ?>, '<?php echo e($ministry->name); ?>')"
        ...
        <div class="col-span-full">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-8 text-center">
                ...
                <a href="<?php echo e(route('ministries.create')); ?>" class="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/rotation/index.blade.php ENDPATH**/ ?>